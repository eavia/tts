...
<body style="width: 980px">
    ...
    <div style="padding: 2px 2px 2px 2px; margin: 2px 2px 2px 2px; width: 980px;">
                ...
                <asp:Table ID="tabItem" runat="server">
                    <asp:TableRow>
                        <asp:TableCell>
                            ...
                            <asp:Literal ID="ltaValue" runat="server" Text='<%#Eval("ProductionDate")%>' />
                        </asp:TableCell><asp:TableCell>
                ...
                <asp:Table ID="tabEditItem" runat="server">
                    <asp:TableRow>
                        <asp:TableCell>
                            ...
                            <asp:TextBox ID="txtProductionDate" runat="server" Text='<%#Eval("ProductionDate")%>'
