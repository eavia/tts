...
namespace TaobaoTesting
{
    ...
    internal class Config
    {
        ...
        static Config()
        {
            ...
            partner = "2088002281506293";

            //交易安全检验码，由数字和字母组成的32位字符串
            key = "hnvvdc3t2s5gxlpy6y1qzr1983dffae3";

            //签约支付宝账号或卖家支付宝帐户
            seller_email = "irvin.xue@gmail.com";

            //页面跳转同步返回页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            return_url = "http://127.0.0.1:51911/PayResult.apsx";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://127.0.0.1:51911/PayNotify.aspx";
