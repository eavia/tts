...
-- --------------------------------------------------
-- Date Created: 08/06/2012 16:34:23
...
GO
IF OBJECT_ID(N'[dbo].[FK_PriceGoods]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntitySet_Price] DROP CONSTRAINT [FK_PriceGoods];
GO
IF OBJECT_ID(N'[dbo].[FK_GoodsGoodsItem]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntitySet_GoodsItem] DROP CONSTRAINT [FK_GoodsGoodsItem];
GO
IF OBJECT_ID(N'[dbo].[FK_ChangedGoodsItem]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntitySet_GoodsItem] DROP CONSTRAINT [FK_ChangedGoodsItem];
GO
...
GO
IF OBJECT_ID(N'[dbo].[FK_Price_inherits_Entity]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntitySet_Price] DROP CONSTRAINT [FK_Price_inherits_Entity];
GO
IF OBJECT_ID(N'[dbo].[FK_GoodsItem_inherits_Entity]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[EntitySet_GoodsItem] DROP CONSTRAINT [FK_GoodsItem_inherits_Entity];
GO
...
GO
IF OBJECT_ID(N'[dbo].[EntitySet_Price]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EntitySet_Price];
GO
IF OBJECT_ID(N'[dbo].[EntitySet_GoodsItem]', 'U') IS NOT NULL
    DROP TABLE [dbo].[EntitySet_GoodsItem];
GO
